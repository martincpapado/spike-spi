...
#define ggc_alloc_riscv_frame_info() ((struct riscv_frame_info *)(ggc_internal_alloc_stat (sizeof (struct riscv_frame_info) MEM_STAT_INFO)))
#define ggc_alloc_cleared_riscv_frame_info() ((struct riscv_frame_info *)(ggc_internal_cleared_alloc_stat (sizeof (struct riscv_frame_info) MEM_STAT_INFO)))
#define ggc_alloc_vec_riscv_frame_info(n) ((struct riscv_frame_info *)(ggc_internal_vec_alloc_stat (sizeof (struct riscv_frame_info), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_riscv_frame_info(n) ((struct riscv_frame_info *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct riscv_frame_info), n MEM_STAT_INFO)))
