...
enum opt_code
{
  ...
  OPT_matomic = 1069,                        /* -matomic */
  OPT_mbranch_cost_ = 1070,                  /* -mbranch-cost= */
  OPT_mfdiv = 1071,                          /* -mfdiv */
  OPT_mhard_float = 1072,                    /* -mhard-float */
  OPT_mlra = 1073,                           /* -mlra */
  OPT_mmemcpy = 1074,                        /* -mmemcpy */
  OPT_mmuldiv = 1075,                        /* -mmuldiv */
  OPT_mplt = 1076,                           /* -mplt */
  OPT_msmall_data_limit_ = 1077,             /* -msmall-data-limit= */
  OPT_msoft_float = 1078,                    /* -msoft-float */
  ...
  OPT_static_liblsan = 1125,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1126,               /* -static-libstdc++ */
  OPT_static_libtsan = 1127,                 /* -static-libtsan */
  OPT_static_libubsan = 1128,                /* -static-libubsan */
  /* OPT_std_c__03 = 1129, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1130, */                /* -std=c++0x */
  OPT_std_c__11 = 1131,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1132, */                /* -std=c++14 */
  OPT_std_c__1y = 1133,                      /* -std=c++1y */
  ...
  /* OPT_std_gnu__14 = 1149, */              /* -std=gnu++14 */
